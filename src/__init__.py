...
def dev():
    ...
    print("   uv run python src/transfer_learning/fine_tuning/train_transfer_learning.py")
    print("\n2. Feature Extraction + SVM Classifier:")
    print("   uv run python src/transfer_learning/feature_extraction/train_classifier.py")
    print("\n3. Test Model:")
